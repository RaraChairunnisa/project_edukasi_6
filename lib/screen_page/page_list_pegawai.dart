...
import 'package:project_edukasi_6/screen_page/page_bottom_navigation.dart';
import 'package:project_edukasi_6/screen_page/page_update_pegawai.dart';
  ...
  Future<void> fetchData() async {
    try {
      final response = await http.get(
          Uri.parse("http://172.20.10.7/edukasi_1/getPegawai.php"));
                                    ...
                                    actions: <Widget>[
                                      ...
                                      TextButton(
                                        onPressed: () {
                                          ...
                                          http.post(
                                            Uri.parse('http://172.20.10.7/edukasi_1/deletePegawai.php'),
                ...
                ElevatedButton(
                  onPressed: () {
                    if (keyForm.currentState?.validate() == true) {
                      ...
                      http.post(
                        Uri.parse('http://172.20.10.7/edukasi_1/simpanPegawai.php'),
                        body: dataPegawai,
                      ).then((response) {
                        // Memeriksa respons dari server
                        if (response.statusCode == 200) {
