...
import 'package:project_edukasi_6/screen_page/page_login_api.dart';
  ...
  Future<List<Datum>?> getBerita() async {
    try {
      http.Response response = await http.get(
        Uri.parse("http://172.20.10.7/edukasi_server/getBerita.php"),
      );
              ...
              onChanged: (value) {
                setState(() {
                  ...
                  element.judul!.toLowerCase().contains(value.toLowerCase()) ||
                      element.berita!.toLowerCase().contains(value.toLowerCase()))
                      .toList();
                });
              },
                            ...
                            child: Column(
                              ...
                              children: [
                                ClipRRect(
                                  ...
                                  child: Image.network(
                                    'http://172.20.10.7/edukasi_1/gambar_berita/${data.gambar}',
                                    fit: BoxFit.cover,
                                  ),
                                ),
                                Padding(
